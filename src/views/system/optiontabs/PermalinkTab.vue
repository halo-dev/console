<template>
  <div>
    <a-form ref="permalinkOptionsForm" :model="options" :rules="rules" layout="vertical" :wrapperCol="wrapperCol">
      ...
      <a-form-item label="自定义页面前缀：" v-show="options.sheet_permalink_type === 'SECONDARY'">
        <template #help>
